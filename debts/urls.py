from debts.views.users import user_detail, user_list_create, authenticated_view, authenticated_super_user, \
    unauthenticated_view, debts_given, debts_received, all_user_debts
...
urlpatterns = [
    ...
    path('users/debts/given/', debts_given, name='debts_given'),
    path('users/debts/received/', debts_received, name='debts_received'),
    path('users/debts/', debts_given, name='debts_given'),
