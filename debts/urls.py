from debts.views.users import user_detail, user_list_create, authenticated_view, authenticated_superuser, unauthenticated_view
...
urlpatterns = [
    ...
    path('authenticated/admin/', authenticated_superuser, name='authenticated_superuser'),
