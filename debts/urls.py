from debts.views.users import user_detail, user_list_create, authenticated_view, authenticated_super_user, unauthenticated_view, debts_given,debts_received
